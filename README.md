...
- **Frontend**: React, TypeScript, Vite, HTML5 Drag and Drop API, react-router-dom
...
- ✅ 드래그 모드로 블록 계층화 (레벨 0-5)
- ✅ 드래그 앤 드롭으로 블록 이동 및 순서 변경
- ✅ 삽입 인디케이터로 정확한 드롭 위치 표시
- ✅ 같은 레벨 내 블록 순서 변경
- ✅ 다른 레벨로 블록 이동
- ✅ 전체 블록 초기화
...
- ✅ 레벨별 색상 구분 및 태그 표시
- ✅ 드래그 모드: 손가락 아이콘으로 활성화, 블록 드래그 앤 드롭
- ✅ 연결선 모드: 블록 간 의존성 관계 시각화
